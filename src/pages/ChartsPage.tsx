...
import { fetchCovidData } from '../features/thunks/covidHistoryData';
...
<div className="min-h-screen bg-gray-100 p-4 sm:p-8">
      ...
      <div className="flex flex-col gap-4 mb-6 sm:mb-8">
        <div 
          className={`p-4 sm:p-6 rounded-lg shadow-md cursor-pointer transition-colors ${
            displayComponent === 'fluctuation' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-blue-100'
          }`}
        ...
        <div 
          className={`p-4 sm:p-6 rounded-lg shadow-md cursor-pointer transition-colors ${
            displayComponent === 'countryWise' ? 'bg-blue-500 text-white' : 'bg-white hover:bg-blue-100'
          }`}
